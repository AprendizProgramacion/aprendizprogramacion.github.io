...
<html lang="es">
    ...
    <body>
        ...
        ?>
        <form name="tryform" class="tryform" method="POST" action="mayor_numeros.php"> 
            <h2>Formulario: comparación</h2>
            <label for="nombre">Primer números</label>   
            <input type="text" id="one" name="one" placeholder="Ingrese número"/><img/><br/>
            <label for="nombre">Segundo números</label>   
            <input type="text" id="two" name="two" placeholder="Ingrese número"/><img/><br/>
